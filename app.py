...
def analyze():
    ...
    all_diaries[current_user].append(new_entry)
    save_data(DIARY_FILE, all_diaries)
...
def history():
    ...
    my_diaries = list(reversed(my_diaries))  # 최신순
...
def view_entry(entry_id):
    ...
    _, viewer_emotion_flow, viewer_gradient = improved_analyzer.analyze_emotion_with_flow(
